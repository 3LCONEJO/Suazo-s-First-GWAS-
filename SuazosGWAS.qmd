---
title: "Identification of loci associated with serum urate concentration through GWAS"
format: 
  revealjs:
    transition: slide
    fontsize: 32px
...
## Post-hoc SNP Call Rate Filtering

-   SNP call rate filtering was additionally applied after the initial GWAS execution.


-   33,750 low-call-rate variants were removed.

-   Genomic inflation remained minimal before filtering ($\lambda = 1.003$).

-   Significant association signals remained unchanged after filtering.

-   Final analysis retained 380,489 SNPs.
...
Functional studies strongly support the biological relevance of *SCLA29* in urate metabolism. Although initially classified as a glucose transporter (*GLUT9*), subsequent experimental evidence demonstrated that its primary physiological role is more closely related to urate transport.
